...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `Para la mejor sapita del universo :\n\nHola sapitaaaaa  feliz cumpleaños!!!!! sapita , que Dios te bendiga muchoteeee, ya llevo un tiempo conociéndote , no hace falta recordarte que sos una niña espectacular , eres alguien muy especial para mi , sabes que te quiero demasido , me alegra mucho poder haberte  conocido durante un pequeño tiempo , eres una niña increíble , y merecedora que te traten como princesa , espero te la pases súper bien este día sapita , que sepas que cualquier cosa que necesites siempre estoy para escucharte y ayudarte en cualquier cosa que pueda y sabes que no te juzgo de ninguna manera, Dios me dio la oportunidad de conocer a alguien increíble , hermosa , bondadosa , cariñosa , amorosa , atenta , amigable, inteligente , talentosa, y recuerda que eres perfecta ante los ojos de Dios y todo lo que sientes miedo o temor , verás que poco a poco toda va ir pasando de la mejor manera , te quiero mucho sapita y feliz cumpleaños`;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con amor, jonathan";
...
function showCountdown() {
  ...
  function update() {
    ...
    container.innerHTML =
      `FELIZ CUMPLE SAPITA: <b>${days}</b> días<br>` +
      `TQM UN MUNDOOO: <b>${eventDays}d ${eventHours}h ${eventMinutes}m ${eventSeconds}s</b>`;
